...
function showTable() {
    employees.forEach((employee, index) => {
      ...
      cell6.innerHTML =  `<input type="submit" value="view" onclick='show(${index})'><button onclick='editEmployee(this)'>Edit</button> <input type="submit" value="delete" onclick=onDelete()> `;
